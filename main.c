...
/**
  ...
  ******************************************************************************
  ******************************************************************************
  Note:Queue is used for the data communication between Two task and will not use global variable
  */
...
osThreadId_t TempCheckHandle;
const osThreadAttr_t TempCheck_attributes = {
  .name = "TempCheck",
  .stack_size = 128 * 4,
...
int main(void)
{
  ...
  TempCheckHandle = osThreadNew(StartTempCheckTask, NULL, &TempCheck_attributes);
...
/**
* @brief Function implementing the TempCheck thread.
* @param argument: Not used
* @retval None
*/
